...
/* ?category=<slug> lets the /products page and any campaign link land
   straight on a filtered shop. */
export default async function ShopPage({
  ...
  const tags = await getTagsInUse(products);
      ...
      <section className="relative overflow-hidden bg-slate-50 px-6 pb-10 pt-32 text-slate-800 sm:pt-36 border-b border-slate-200/60">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mt-4 max-w-2xl text-base text-slate-600">
            ...
            faucets. Choose the model that suits your water, add it to your
            basket and place your order — an agent will call you to confirm.
          </p>
              ...
              {[
                {
                  n: "01",
                  t: "Choose your model",
                  d: "Pick the model that suits your water supply, and add it to your basket.",
                },
                {
                  n: "02",
                  t: "Place your order",
